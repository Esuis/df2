...
class SubagentExecutor:
    ...
    def _create_agent(self, tools: list[BaseTool] | None = None, *, deferred_setup: "DeferredToolSetup | None" = None):
        ...
        model = create_chat_model(name=self.model_name, thinking_enabled=False, app_config=app_config, attach_tracing=False, runtime_model_override=self.runtime_model_override, add_think=self.add_think)
